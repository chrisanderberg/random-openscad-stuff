// Emersed Plant Platform - Glad Container Version
...
platform_points = [[20, 0], [80, 0], [92, 10], [100, 50], [100, 110], [92, 150], [80, 160], [20, 160], [8, 150], [0, 110], [0, 50], [8, 10]]; // Example polygon; replace with your polygon.
rim_width = 5;
leg_length = 20;
leg_max_spacing = 50;

// Middle legs.
middle_leg_positons = [[50, 50], [50, 110]]; // Example positions; replace with your middle leg positions.
middle_leg_lengths = [18, 18]; // Example lengths; replace with your middle leg lengths.
