...
- The lid guard shall use a top flange larger than the opening and an
  underside locating lip smaller than the opening so the part cannot fall
  through when installed from above.
...
## Open questions
- Confirm the final measured opening width, opening height, and corner radius
  on the physical lid before exporting a production mesh.
- Confirm how much underside lip depth is available before the guard would
  interfere with water level, floating plants, or nearby hardware.
